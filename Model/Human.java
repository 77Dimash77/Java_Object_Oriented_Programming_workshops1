...
public class Human implements Serializable {
    ...
    public Human(String surname, String name, Gender gender, LocalDate dateOfBirth, LocalDate dateOfDeath, Integer generation) {
        this.surname = surname;
        this.name = name;
        this.gender = gender;
        this.dateOfBirth = dateOfBirth;
    ...
    public String toString() {
        ...
        if (!contactInfoList.isEmpty()) {
            ...
            sb.append("Контактная информация отсутствует\n");
        }
